GravatarImageTag.configure do |config|
  config.default_image           = 'http://en.gravatar.com/userimage/54759533/239d9f9d707a3692c1b3d23fd1c61155.png'#nil#'http://esurancexchange.com/development/public/front/images/first.png'#nil   # Set this to use your own default gravatar image rather then serving up Gravatar's default image [ 'http://example.com/images/default_gravitar.jpg', :identicon, :monsterid, :wavatar, 404 ].
