		...
		var defaults = {
			...
			pushTag : function(tag, ignoreEvents) {
				...
				if (alreadyInList) {
					...
					$("#" + $self.data("tm_rndid") + "_" + tlid[idx]).stop().animate({
					...
					html = '<li class="' + privateMethods.tagClasses.call($self) + '" id="' + newTagId + '">';
					html += '<span>' + escaped + '</span>';
					html += '<a href="#" class="tm-tag-remove" id="' + newTagRemoveId + '" TagIdToRemove="' + tagId + '">';
					html += opts.tagCloseIcon + '</a></li> ';
					$el = $(html);
			...
			init : function(options) {
				...
				delimiters = opts.delimeters || opts.delimiters;
				// 'delimeter' is deprecated
				keyNums = [9, 13, 17, 18, 19, 37, 38, 39, 40];
				...
				this.each(function() {
					...
					$self.data('opts', opts).data('tlis', [])//list of string tags
					.data('tlid', []);
					//list of ID of the string tags
