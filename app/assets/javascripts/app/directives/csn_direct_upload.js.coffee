angular.module('optimizePlayer').directive 'csnDirectUpload', ['$rootScope', '$http', '$timeout', '$sce', ($rootScope, $http, $timeout, $sce) ->
  restrict: 'E'
    ...
    $element.fileupload angular.extend(
      ...
      progressall: (e, data) ->
        $scope.$apply ->
          ...
          if $scope.$parent.onProgressChange()
            $scope.$parent.onProgressChange(percentage)
        ...
        $scope.$apply ->
          ...
          $scope.$parent.onDone(remote_url, true)
          $rootScope.isLoadingFile = false
